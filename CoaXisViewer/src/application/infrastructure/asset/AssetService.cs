...
public partial class AssetService : Node
{
    ...
    private const string DefaultIconPath = "res://assets/icon/mono/question.svg";
    ...
    /// <param name="size">返却アイコンのサイズ</param>
    /// <returns>取得したアイコン、失敗時は null</returns>
    internal Texture2D GetDefaultIcon(int size = 16)
    {
        return GetIcon(DefaultIconPath, size);
    }
