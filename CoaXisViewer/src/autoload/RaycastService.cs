...
public partial class RaycastService : Node
{
	...
	/// <param name="collisionMask">レイキャストの衝突マスク。デフォルトは全てのレイヤー。</param>
	/// <returns>レイのヒット情報を含む RaycastHitInfo 構造体。</returns>
	public static RaycastHitInfo RaycastFromScreen(Camera3D camera, Vector2 screenPos, uint collisionMask = uint.MaxValue)
	{
