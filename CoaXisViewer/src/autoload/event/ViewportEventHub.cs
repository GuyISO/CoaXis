...
public partial class ViewportEventHub : Node
{
	...
	{
		Instance.EmitSignal(SignalName.NotifyStateRequested);
	}
	...
	{
		Instance.EmitSignal(SignalName.MovePositionToRequested, position, useTween);
	}
	...
	{
		Instance.EmitSignal(SignalName.MoveRotationToRequested, rotation, useTween);
	}
	...
	{
		Instance.EmitSignal(SignalName.SetDistanceRequested, distance, useTween);
	}
	...
	{
		Instance.EmitSignal(SignalName.SetSizeRequested, size, useTween);
	}
	...
	{
		Instance.EmitSignal(SignalName.SetFovRequested, fov, useTween);
	}
	...
	{
		Instance.EmitSignal(SignalName.TranslateRequested, translation, (int)spaceMode, useTween);
	}
	...
	{
		Instance.EmitSignal(SignalName.RotateRequested, rotation, (int)spaceMode, useTween);
	}
	...
	{
		Instance.EmitSignal(SignalName.ZoomRequested, exponent, useTween);
	}
	...
	{
		Instance.EmitSignal(SignalName.SetProjectionTypeRequested, (int)type);
	}
	...
	{
		Instance.EmitSignal(SignalName.ToggleProjectionTypeRequested);
	}
	...
	public static void RequestFit(IEnumerable<Node3D> targetNodes, bool useTween = false)
	{
		...
		Instance.EmitSignal(SignalName.FitRequested, targets, useTween);
	}
	...
	{
		Instance.EmitSignal(SignalName.AlignNormalToRequested, normal, useTween);
	}
	...
	{
		Instance.EmitSignal(SignalName.DecideSelectionRectRequested, startPosition, endPosition);
	}
	...
	{
		Instance.EmitSignal(SignalName.InputModeNotified, (int)mode);
	}
	...
	{
		Instance.EmitSignal(SignalName.PositionNotified, position);
	}
	...
	{
		Instance.EmitSignal(SignalName.RotationNotified, rotation);
	}
	...
	{
		Instance.EmitSignal(SignalName.DistanceNotified, distance);
	}
	...
	{
		Instance.EmitSignal(SignalName.SizeNotified, size);
	}
	...
	{
		Instance.EmitSignal(SignalName.FovNotified, fov);
	}
	...
	{
		Instance.EmitSignal(SignalName.ProjectionTypeNotified, (int)type);
	}
	...
	{
		Instance.EmitSignal(SignalName.ArcballRadiusNotified, radius);
	}
	...
	{
		Instance.EmitSignal(SignalName.ArcballHandleNotified, position);
	}
	...
	{
		Instance.EmitSignal(SignalName.SelectionRectNotified, startPosition, endPosition);
	}
